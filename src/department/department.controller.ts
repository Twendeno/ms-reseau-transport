...
export class DepartmentController {
  ...
  @Get(":uuidOrName")
  findOne(@Param("uuidOrName") uuidOrName: string): Promise<JsonApiResponse<DepartmentDto>> {
    return this.departmentService.findOne(uuidOrName);
  }

  @Post()
  create(@Body() departmentDto: DepartmentDto): Promise<JsonApiResponse<DepartmentDto>> {
    return this.departmentService.create(departmentDto);
  }

  @Put(":uuid")
  update(@Param("uuid") uuid: string, @Body() departmentDto: DepartmentDto): Promise<JsonApiResponse<DepartmentDto>> {
