...
describe('GeometryController', () => {
  ...
  describe('findOne', () => {
    it('should return a geometry', () => {
      const uuid = "1";
      const geometry = geometryModelMock.find(geometry => geometry.uuid === uuid);
  ...
  describe('create', () => {
    it('should return a geometry', () => {
      expect(controller.create(geometryModelMock[0])).resolves.toEqual({message: "Geometry created"});
    });
  });

  describe('update', () => {
    it('should return a geometry', () => {
      expect(controller.update("1",geometryModelMock[0])).resolves.toEqual({message: "Geometry updated"});
    });
  });

  describe('delete', () => {
    it('should return a geometry', () => {
      expect(controller.delete("1")).resolves.toEqual({message: "Geometry deleted"});
    });
  });
  ...
  describe('findByReference', () => {
    it('should return a geometry', () => {
      const ref = "abc";
      const geometry = geometryModelMock.find(geometry => geometry.reference === ref);
