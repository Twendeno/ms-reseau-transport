...
export class CoordinatePolygonController {
  ...
  @Get(':uuid')
  findOne(@Param('uuid') uuid: string): Promise<JsonApiResponse<CoordinatePolygonDto>> {
    return this.coordinatePolygonService.findOne(uuid);
  }

  @Post()
  create(@Body() coordinatePolygonDto: CoordinatePolygonDto): Promise<JsonApiResponse<CoordinatePolygonDto>> {
    return this.coordinatePolygonService.create(coordinatePolygonDto);
  }

  @Put(':uuid')
  update(@Param('uuid') uuid: string,@Body() coordinatePolygonDto: CoordinatePolygonDto): Promise<JsonApiResponse<CoordinatePolygonDto>> {
    return this.coordinatePolygonService.update(uuid, coordinatePolygonDto);
  }

  @Delete(':uuid')
  delete(@Param('uuid') uuid: string): Promise<JsonApiResponse<CoordinatePolygonDto>> {
    return this.coordinatePolygonService.delete(uuid);
  }

  @Get('line/:uuid')
  findCoordinatePolygonByGeometryUuid(uuid: string): Promise<JsonApiResponse<CoordinatePolygonDto[]>> {
